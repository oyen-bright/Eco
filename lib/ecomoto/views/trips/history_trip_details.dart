...
class HistoryTripDetailsView extends StatelessWidget {
  final Trip tripDetails;
  const HistoryTripDetailsView({super.key, required this.tripDetails});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppViewBar.small(
        ...
        centerTitle: true,
        title: Strings.historyDetailsViewTitle,
      ),
      body: Container(
