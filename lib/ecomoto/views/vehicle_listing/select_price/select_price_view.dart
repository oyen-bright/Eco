...
part 'components/price_selector.dart';
part 'components/select_price.dart';
part 'constants/strings.dart';

class SelectPriceView extends StatelessWidget {
  final VehicleModel vehicleInputData;
  const SelectPriceView({super.key, required this.vehicleInputData});
    ...
    return VehicleListingWrapper(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
              child: SelectVehiclePrice(vehicleInputData: vehicleInputData)),
